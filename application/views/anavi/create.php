			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>anavi/create">创建</a>
					</li>
				</ul>
			</div>	
				...
				<div class="box span12">
					...
					<div class="box-content">
						<div class="control-group" style="margin: 8px;">
							<form id="frm" method="post" action="<?=base_url()?>anavi/createSubmit">
								...
								<table class="table" style="width:70%;margin:0 auto 10px;border:0px;" >
									...
									<tr>
										...
										<td>
											<label class="radio">
												<input type="radio" name="level" value="1" checked <?php if ($navi['level'] == "1") echo "checked";?>>1
											</label>
											<label class="radio">
