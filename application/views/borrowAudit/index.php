	...
	#table_search td {padding-right: 14px;}
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#">借款客户审核</a><span class="divider">></span>
					</li>
					<li>
						<a href="<?=base_url()?>borrowAudit/index<?=$borrowAuditStatus?>"><?=$borrowAuditStatusName?></a><span class="divider"></span>
					</li>
				</ul>
			</div>	
				...
				<div class="box span12">
					...
					<div class="box-content">
						<div class="control-group" style="margin: 8px;">
							<form id="frm" method="post" action="<?=base_url()?>borrowAudit/<?=$action?>">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<?php if ($borrowAuditStatus < 9) { ?>
									<a href="javascript:createAudit('<?=$borrowAuditStatus?>', <?=$borrow['id'] ?>)">审核</a>
									<?php } ?>
									<a href="<?=base_url()?>borrow/viewDetail/<?=$borrow['id'] ?>">查看</a>
									<a href="<?=base_url()?>borrow/editRequest/<?=$borrow['id'] ?>">变更申请</a>
								</td>
							</tr>
							<?php } ?>
						  </tbody>
			...
			function createAudit(status, id) {

				var win = window.showModalDialog("<?=base_url()?>borrowAudit/create"+status+"/"+id,"newwin","dialogHeight: 540px; dialogWidth: 750px; dialogTop: 110px; dialogLeft: 166px; edge: Raised; center: Yes; help: Yes; resizable: Yes; status: Yes;");
				if (win != 'True') {
