							    ...
							    <tbody>
									...
									<tr>
										...
										<td><?php if ($item['attachment'] != "") { ?>
											<a href="<?=base_url()?>borrowAudit/download/<?=$borrow_id?>/<?=$item['attachment']?>">
												<?=$item['status']?>
											</a>
											<?php } else {?>
												<?=$item['status']?>
										...
										<td><?=$item['remark']?></td>	
										<td><a href="javascript:deleteItem(<?=$item['id'] ?>, 'borrowAudit')">删除</a></td>
									</tr>
									<?php }?>
								</tbody>
							</table>
							...
							<table style="width:100%;margin:0 auto;" class="table table-bordered table-striped bootstrap-datatable datatable">
								<thead>
									<tr>
										...
										<td style="text-align:center">操作&nbsp;<a href="javascript:createItem('borrowBank', <?=$borrow_id?>)">创建</a></td>
									</tr>
								</thead>
								<tbody>
							...
							<table style="width:100%;margin:0 auto;" class="table table-bordered table-striped bootstrap-datatable datatable">
								<thead>
									<tr>
										...
										<td style="text-align:center">操作&nbsp;<a href="javascript:createItem('borrowContact', <?=$borrow_id?>)">创建</a></td>
									</tr>
								</thead>
								<tbody>
							...
							<table style="width:100%;margin:0 auto;" class="table table-bordered table-striped bootstrap-datatable datatable">
								<thead>
									<tr>
										...
										<td style="text-align:center">操作&nbsp;<a href="javascript:createAttachment('1', <?=$borrow_id ?>)">创建</a></td>
									</tr>
								</thead>
								<tbody>
							...
							<table style="width:100%;margin:0 auto;" class="table table-bordered table-striped bootstrap-datatable datatable">
								<thead>
									<tr>
										...
										<td style="text-align:center">创建用户</td>
										<td style="text-align:center">创建时间</td>
										<td style="text-align:center">操作&nbsp;<a href="javascript:createAttachment('2', <?=$borrow_id ?>)">创建</a></td>
									</tr>
								</thead>
								<tbody>
							...
							<table style="width:100%;margin:0 auto;" class="table table-bordered table-striped bootstrap-datatable datatable">
								<thead>
									<tr>
										...
										<td style="text-align:center">创建用户</td>
										<td style="text-align:center">创建时间</td>
										<td style="text-align:center">操作&nbsp;<a href="javascript:createAttachment('3', <?=$borrow_id ?>)">创建</a></td>
									</tr>
								</thead>
								<tbody>
							...
							<table style="width:100%;margin:0 auto;" class="table table-bordered table-striped bootstrap-datatable datatable">
								<thead>
									<tr>
										...
										<td style="text-align:center">创建用户</td>
										<td style="text-align:center">创建时间</td>
										<td style="text-align:center">操作&nbsp;<a href="javascript:createAttachment('4', <?=$borrow_id ?>)">创建</a></td>
									</tr>
								</thead>
								<tbody>
